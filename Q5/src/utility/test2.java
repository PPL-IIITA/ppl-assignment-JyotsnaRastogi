...
public class test2 {
    public void tester() throws IOException {   /*function for random value generation and writing to file*/ 
        ...
        int i,t;
         try {
              BufferedWriter w=new BufferedWriter(new FileWriter("src\\boy.csv",false));
        for(i=0;i<20;i++) {
      ...
      try {
              BufferedWriter w=new BufferedWriter(new FileWriter("src\\girl.csv",false));
        for(i=0;i<12;i++) {
        ...
        w.close();
         ...
         try {
              BufferedWriter w=new BufferedWriter(new FileWriter("src\\gift.csv",false));
        for(i=0;i<10;i++) {
